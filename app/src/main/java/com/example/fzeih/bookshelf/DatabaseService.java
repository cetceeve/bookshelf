...
class DatabaseService {
    ...
    static class AchievementService {
        ...
        public ArrayList<Achievement> getAchievementList(Context context) {
            ...
            achievements.add(new Achievement(context, 10, R.string.achievement_10, R.mipmap.ic_launcher_round));
            achievements.add(new Achievement(context, 25, R.string.achievement_25, R.mipmap.ic_launcher_round));
            achievements.add(new Achievement(context, 50, R.string.achievement_50, R.mipmap.ic_launcher_round));
            achievements.add(new Achievement(context, 100, R.string.achievement_100, R.mipmap.ic_launcher_round));
            achievements.add(new Achievement(context, 250, R.string.achievement_250, R.mipmap.ic_launcher_round));
            achievements.add(new Achievement(context, 500, R.string.achievement_500, R.mipmap.ic_launcher_round));
            achievements.add(new Achievement(context, 750, R.string.achievement_750, R.mipmap.ic_launcher_round));
            achievements.add(new Achievement(context, 1000, R.string.achievement_1000, R.mipmap.ic_launcher_round));
            achievements.add(new Achievement(context, 5000, R.string.achievement_5000, R.mipmap.ic_launcher_round));
            return achievements;
        }
